...
export const INITIAL_OFFICIALS: BarangayOfficial[] = [
  { 
    official_id: 'OFF-001', 
    full_name: 'Hon. Nestor Nabaunag Jr.', 
    ...
    term_end: '2026-12-31',
    status: 'Active',
    avatar_url: '/barangay-logo.png'
  },
  { 
    official_id: 'OFF-002', 
    full_name: 'Sally Espinosa', 
    position: 'Barangay Secretary', 
    committee: 'Records and Documentation',
  ...
  { 
    official_id: 'OFF-004', 
    full_name: 'Ramon G. Dela Cruz', 
    position: 'Barangay Kagawad', 
    committee: 'Peace and Order',
    contact_number: '0917-123-0004',
    email: 'ramon.delacruz@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    ...
    email: 'maria.santos@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    official_id: 'OFF-006', 
    full_name: 'Pedro M. Reyes', 
    position: 'Barangay Kagawad', 
    committee: 'Infrastructure and Public Works',
    contact_number: '0917-123-0006',
    email: 'pedro.reyes@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    official_id: 'OFF-007', 
    full_name: 'Luzviminda T. Fernandez', 
    position: 'Barangay Kagawad', 
    committee: 'Education and Culture',
    contact_number: '0917-123-0007',
    email: 'luz.fernandez@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    official_id: 'OFF-008', 
    full_name: 'Ricardo V. Mendoza', 
    position: 'Barangay Kagawad', 
    committee: 'Agriculture and Livelihood',
    contact_number: '0917-123-0008',
    email: 'ricardo.mendoza@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    official_id: 'OFF-009', 
    full_name: 'Teresita C. Ramos', 
    position: 'Barangay Kagawad', 
    committee: 'Women and Family Welfare',
    contact_number: '0917-123-0009',
    email: 'teresita.ramos@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
  { 
    official_id: 'OFF-010', 
    full_name: 'Roberto S. Villanueva', 
    position: 'Barangay Kagawad', 
    committee: 'Youth and Sports Development',
    contact_number: '0917-123-0010',
    email: 'roberto.villanueva@barangaysf2.gov.ph',
    term_start: '2023-01-01',
    term_end: '2026-12-31',
    status: 'Active'
  },
